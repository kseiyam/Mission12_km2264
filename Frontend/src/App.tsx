...
const collegeNames: CollegeData[] = [
...
function Welcome() {
  return <h1>Welcome! This page lists all colleges that are part of the NCAA Basketball along with some information on the college.</h1>;
}
  ...
  return (
    <div>
      {collegeNames.map((oneCollege) => (
        <College
          key={oneCollege.tid}
          school={oneCollege.school}
          name={oneCollege.name}
          city={oneCollege.city}
          state={oneCollege.state}
        />
      ))}
    </div>
  );
